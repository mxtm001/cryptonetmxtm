...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (currentUserData) {
        // Update user balance to €12,000
        currentUserData.balance = 12000
        currentUserData.currency = "EUR"

        // Update in localStorage
        const updatedUsers = registeredUsers.map((u: any) =>
          u.email === userData.email ? { ...u, balance: 12000, currency: "EUR" } : u,
        )
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-[#f9a826]">{formatCurrency(12000, "EUR")}</p>
                  </div>
